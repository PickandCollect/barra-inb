    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div id="content">
                ...
                <!-- Encabezado -->
                <div class="header">
                    <div class="title">METRICAS CALIDAD</div>
                ...
                <div class="contenidos">
                    <a href="metricas_bbva.php" class="metric-box container_bbva">
                        <h1>Metricas BBVA</h1>
                    </a>
                    <a href="metricas_hdi.php" class="metric-box container_hdi">
                        <h1>Metricas HDI</h1>
                    </a>
                    <a href="metricas_rh.php" class="metric-box container_rh">
                        <h1>Metricas RH</h1>
                    </a>
                </div>
