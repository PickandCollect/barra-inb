...
<head>
    ...
    <link rel="stylesheet" href="css/metricas_bbva.css">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <!-- Encabezado -->
                <div class="header">
                    <div class="title">METRICAS BBVA</div>
                ...
                <section class="pdf-section-wrapper">
                    ...
                    <div class="pdf-filters">
                        <!-- Filtro por operador -->
                        <div class="pdf-filter-input-wrapper">
                            <label for="filtroOperadorPDF" class="pdf-filter-label">
                                <i class="fas fa-user-shield"></i>
                                <span>Operador</span>
                            </label>
                            <div class="pdf-select-wrapper">
                                <select id="filtroOperadorPDF" class="pdf-premium-select">
