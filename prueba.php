        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <button type="button" class="btn btn-primary" id="abrirCedulaHDI">
                        Abrir Cédula HDI
                    </button>

                    <!-- Modal (el resto igual que antes) -->
                    <div class="modal" id="cedulaModalHDI" ...>
                        ...
                    </div>
                </div>
                ...
                <script>
                    $(document).ready(function() {
                        $('#abrirCedulaHDI').click(function() {
                            // Abre el modal
                            $('#cedulaModalHDI').modal('show');

                            // Carga el contenido de cedula_hdi.php en el modal
                            $('#cedulaModalContentHDI').load('cedula_bbva.php');
                        });
                    });
                </script>
