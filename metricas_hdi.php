...
<head>
    ...
    <link rel="stylesheet" href="css/metricas_hdi.css">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <!-- Encabezado -->
                <div class="header">
                    <div class="title">METRICAS HDI</div>
        ...
        <!--SCRIPT de métricas - Control de Gráficas-->
        <script>
            // Configuración de Firebase
            ...
            // Función para determinar las campañas permitidas (solO HDI)
            function obtenerCampanasPermitidas() {
                return ["HDI"]; // Solo mostramos datos de HDI
            }
            ...
            $(document).ready(function() {
                ...
                $('#btnLimpiarFiltro').click(function() {
                    ...
                    Swal.fire({
                        ...
                        text: 'Se mostrarán todos los registros de HDI',
                        icon: 'success',
                        timer: 1500,
                ...
                async function cargarTablaOperadores() {
                    try {
                        ...
                        snapshot.forEach(childSnapshot => {
                            ...
                            // Solo incluir registros de HDI
                            const campanaValida = itemCampana.toLowerCase().includes('hdi');
                ...
                // Función para cargar lista de operadores (solo de HDI)
                async function cargarOperadores() {
                    try {
                        ...
                        snapshot.forEach(childSnapshot => {
                            const item = childSnapshot.val();
                            if (item.operador && item.campana && item.campana.toLowerCase().includes('hdi')) {
                ...
                // Función para obtener datos filtrados (solo HDI)
                async function obtenerDatosFiltrados(filtrarPorOperador) {
                    ...
                    datosRadial.forEach(item => {
                        if (item.cumple1_1 === 'SI') conteoCumplimiento['Presentación Institucional']++;
                        if (item.cumple1_2 === 'SI') conteoCumplimiento['Presentación Institucional']++;
                        if (item.cumple1_3 === 'SI') conteoCumplimiento['Presentación Institucional']++;
                        if (item.cumple1_4 === 'SI') conteoCumplimiento['Presentación Institucional']++;

                        if (item.cumple2_1 === 'SI') conteoCumplimiento['Despedida institucional']++;
                        if (item.cumple2_2 === 'SI') conteoCumplimiento['Despedida institucional']++;
                        if (item.cumple2_3 === 'SI') conteoCumplimiento['Despedida institucional']++;
                        if (item.cumple2_4 === 'SI') conteoCumplimiento['Despedida institucional']++;

                        if (item.cumple3_1 === 'SI') conteoCumplimiento['Identifica al receptor']++;
                        if (item.cumple3_2 === 'SI') conteoCumplimiento['Identifica al receptor']++;
                        if (item.cumple3_3 === 'SI') conteoCumplimiento['Identifica al receptor']++;
                        if (item.cumple3_4 === 'SI') conteoCumplimiento['Identifica al receptor']++;

                        if (item.cumple4_1 === 'SI') conteoCumplimiento['Sondeo y Captura']++;
                        if (item.cumple4_2 === 'SI') conteoCumplimiento['Sondeo y Captura']++;
                        if (item.cumple4_3 === 'SI') conteoCumplimiento['Sondeo y Captura']++;
                        if (item.cumple4_4 === 'SI') conteoCumplimiento['Sondeo y Captura']++;

                        if (item.cumple5_1 === 'SI') conteoCumplimiento['Escucha activa']++;
                        if (item.cumple5_2 === 'SI') conteoCumplimiento['Escucha activa']++;
                        if (item.cumple5_3 === 'SI') conteoCumplimiento['Escucha activa']++;
                        if (item.cumple5_4 === 'SI') conteoCumplimiento['Escucha activa']++;

                        if (item.cumple6_1 === 'SI') conteoCumplimiento['Brinda información correcta y completa']++;
                        if (item.cumple6_2 === 'SI') conteoCumplimiento['Brinda información correcta y completa']++;
                        if (item.cumple6_3 === 'SI') conteoCumplimiento['Brinda información correcta y completa']++;
                        if (item.cumple6_4 === 'SI') conteoCumplimiento['Brinda información correcta y completa']++;

                        if (item.cumple7_1 === 'SI') conteoCumplimiento['Uso del mute y Tiempos de espera']++;
                        if (item.cumple7_2 === 'SI') conteoCumplimiento['Uso del mute y Tiempos de espera']++;
                        if (item.cumple7_3 === 'SI') conteoCumplimiento['Uso del mute y Tiempos de espera']++;
                        if (item.cumple7_4 === 'SI') conteoCumplimiento['Uso del mute y Tiempos de espera']++;

                        if (item.cumple8_1 === 'SI') conteoCumplimiento['Manejo de Objeciones']++;
                        if (item.cumple8_2 === 'SI') conteoCumplimiento['Manejo de Objeciones']++;
                        if (item.cumple8_3 === 'SI') conteoCumplimiento['Manejo de Objeciones']++;
                        if (item.cumple8_4 === 'SI') conteoCumplimiento['Manejo de Objeciones']++;

                        if (item.cumple9_1 === 'SI') conteoCumplimiento['Realiza pregunta de cortesía']++;
                        if (item.cumple9_2 === 'SI') conteoCumplimiento['Realiza pregunta de cortesía']++;
                        if (item.cumple9_3 === 'SI') conteoCumplimiento['Realiza pregunta de cortesía']++;
                        if (item.cumple9_4 === 'SI') conteoCumplimiento['Realiza pregunta de cortesía']++;

                        if (item.cumple10_1 === 'SI') conteoCumplimiento['Personalización']++;
                        if (item.cumple10_2 === 'SI') conteoCumplimiento['Personalización']++;
                        if (item.cumple10_3 === 'SI') conteoCumplimiento['Personalización']++;
                        if (item.cumple10_4 === 'SI') conteoCumplimiento['Personalización']++;

                        if (item.cumple11_1 === 'SI') conteoCumplimiento['Manejo del vocabulario']++;
                        if (item.cumple11_2 === 'SI') conteoCumplimiento['Manejo del vocabulario']++;
                        if (item.cumple11_3 === 'SI') conteoCumplimiento['Manejo del vocabulario']++;
                        if (item.cumple11_4 === 'SI') conteoCumplimiento['Manejo del vocabulario']++;

                        if (item.cumple12_1 === 'SI') conteoCumplimiento['Muestra control en la llamada']++;
                        if (item.cumple12_2 === 'SI') conteoCumplimiento['Muestra control en la llamada']++;
                        if (item.cumple12_3 === 'SI') conteoCumplimiento['Muestra control en la llamada']++;
                        if (item.cumple12_4 === 'SI') conteoCumplimiento['Muestra control en la llamada']++;

                        if (item.cumple13_1 === 'SI') conteoCumplimiento['Muestra cortesía y empatía']++;
                        if (item.cumple13_2 === 'SI') conteoCumplimiento['Muestra cortesía y empatía']++;
                        if (item.cumple13_3 === 'SI') conteoCumplimiento['Muestra cortesía y empatía']++;
                        if (item.cumple13_4 === 'SI') conteoCumplimiento['Muestra cortesía y empatía']++;

                        if (item.cumple14_1 === 'SI') conteoCumplimiento['Maltrato al cliente']++;
                        if (item.cumple14_2 === 'SI') conteoCumplimiento['Maltrato al cliente']++;
                        if (item.cumple14_3 === 'SI') conteoCumplimiento['Maltrato al cliente']++;
                        if (item.cumple14_4 === 'SI') conteoCumplimiento['Maltrato al cliente']++;

                        if (item.cumple15_1 === 'SI') conteoCumplimiento['Desprestigio institucional']++;
                        if (item.cumple15_2 === 'SI') conteoCumplimiento['Desprestigio institucional']++;
                        if (item.cumple15_3 === 'SI') conteoCumplimiento['Desprestigio institucional']++;
                        if (item.cumple15_4 === 'SI') conteoCumplimiento['Desprestigio institucional']++;

                    });

                    const porcentajes = metricas.map(metrica => {
                        return totalEvaluaciones > 0 ?
                            Math.round((conteoCumplimiento[metrica] / totalEvaluaciones) * 20) :
                            0;
                    });
                ...
                // Función para exportar datos a Excel (solo BBVA)
                    ...
                    try {
                        ...
                        const datosExcel = datosRadial.map(item => {
                            return {
                                ...
                                'Presentación Institucional 1': item.cumple1_1 || 'NO',
                                'Presentación Institucional 2': item.cumple1_2 || 'NO',
                                'Presentación Institucional 3': item.cumple1_3 || 'NO',
                                'Presentación Institucional 4': item.cumple1_4 || 'NO',

                                'Despedida institucional 1': item.cumple2_1 || 'NO',
                                'Despedida institucional 2': item.cumple2_2 || 'NO',
                                'Despedida institucional 3': item.cumple2_3 || 'NO',
                                'Despedida institucional 4': item.cumple2_4 || 'NO',

                                'Identifica al receptor 1': item.cumple3_ || 'NO',
                                'Identifica al receptor 2': item.cumple3_ || 'NO',
                                'Identifica al receptor 3': item.cumple3_ || 'NO',
                                'Identifica al receptor 4': item.cumple3_ || 'NO',

                                'Sondeo y Captura 1': item.cumple4_ || 'NO',
                                'Sondeo y Captura 2': item.cumple4_ || 'NO',
                                'Sondeo y Captura 3': item.cumple4_ || 'NO',
                                'Sondeo y Captura 4': item.cumple4_ || 'NO',

                                'Escucha activa 1': item.cumple5_ || 'NO',
                                'Escucha activa 2': item.cumple5_ || 'NO',
                                'Escucha activa 3': item.cumple5_ || 'NO',
                                'Escucha activa 4': item.cumple5_ || 'NO',

                                'Brinda información correcta y completa 1': item.cumple6_ || 'NO',
                                'Brinda información correcta y completa 2': item.cumple6_ || 'NO',
                                'Brinda información correcta y completa 3': item.cumple6_ || 'NO',
                                'Brinda información correcta y completa 4': item.cumple6_ || 'NO',

                                'Uso del mute y Tiempos de espera 1': item.cumple7_ || 'NO',
                                'Uso del mute y Tiempos de espera 2': item.cumple7_ || 'NO',
                                'Uso del mute y Tiempos de espera 3': item.cumple7_ || 'NO',
                                'Uso del mute y Tiempos de espera 4': item.cumple7_ || 'NO',

                                'Manejo de Objeciones 1': item.cumple8_ || 'NO',
                                'Manejo de Objeciones 2': item.cumple8_ || 'NO',
                                'Manejo de Objeciones 3': item.cumple8_ || 'NO',
                                'Manejo de Objeciones 4': item.cumple8_ || 'NO',

                                'Realiza pregunta de cortesía 1': item.cumple9_ || 'NO',
                                'Realiza pregunta de cortesía 2': item.cumple9_ || 'NO',
                                'Realiza pregunta de cortesía 3': item.cumple9_ || 'NO',
                                'Realiza pregunta de cortesía 4': item.cumple9_ || 'NO',

                                'Personalización 1': item.cumple10_ || 'NO',
                                'Personalización 2': item.cumple10_ || 'NO',
                                'Personalización 3': item.cumple10_ || 'NO',
                                'Personalización 4': item.cumple10_ || 'NO',

                                'Manejo del vocabulario 1': item.cumple11_ || 'NO',
                                'Manejo del vocabulario 2': item.cumple11_ || 'NO',
                                'Manejo del vocabulario 3': item.cumple11_ || 'NO',
                                'Manejo del vocabulario 4': item.cumple11_ || 'NO',

                                'Muestra control en la llamada 1': item.cumple12_ || 'NO',
                                'Muestra control en la llamada 2': item.cumple12_ || 'NO',
                                'Muestra control en la llamada 3': item.cumple12_ || 'NO',
                                'Muestra control en la llamada 4': item.cumple12_ || 'NO',

                                'Muestra cortesía y empatía 1': item.cumple13_ || 'NO',
                                'Muestra cortesía y empatía 2': item.cumple13_ || 'NO',
                                'Muestra cortesía y empatía 3': item.cumple13_ || 'NO',
                                'Muestra cortesía y empatía 4': item.cumple13_ || 'NO',

                                'Maltrato al cliente 1': item.cumple14_ || 'NO',
                                'Maltrato al cliente 2': item.cumple14_ || 'NO',
                                'Maltrato al cliente 3': item.cumple14_ || 'NO',
                                'Maltrato al cliente 4': item.cumple14_ || 'NO',

                                'Desprestigio institucional 1': item.cumple15_ || 'NO',
                                'Desprestigio institucional 2': item.cumple15_ || 'NO',
                                'Desprestigio institucional 3': item.cumple15_ || 'NO',
                                'Desprestigio institucional 4': item.cumple15_ || 'NO',
        ...
        <!--SCRIPT de métricas - Visualizador PDF-->
        <script>
            const db1 = firebase.database();
            const pdfRef = db.ref('PDF_HDI');
            ...
            pdfRef.on('value', (snapshot) => {
                ...
                for (const key in pdfs) {
                    ...
                    link.addEventListener('click', (e) => {
                        e.preventDefault();
                        pdfViewer.innerHTML = `
                    <iframe src="${pdf.fileUrl}" width="100%" height="600px" frameborder="0"></iframe>
                `;
                    });
