...
// Consulta SQL para obtener la cantidad de casos agrupados por subestatus
$query = "SELECT subestatus, COUNT(*) AS total_casos FROM Cedula GROUP BY subestatus";
